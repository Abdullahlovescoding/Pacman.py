...
class KeyboardAgent(Agent):
    ...
    def getAction(self, state):
        ...
        #print("Printing keys pressed")
        #print(type(keys_pressed()))
        #print(keys_pressed())
        #print("Printing keys waiting")
        #print(type(keys_waiting()))
        #print(keys_waiting())
    ...
    def getmove(self, legal):
        ...
        if not self.keys:
            move = Directions.STOP
        elif (self.WEST_KEY in self.keys or 'Left' in self.keys) and Directions.WEST in legal:
